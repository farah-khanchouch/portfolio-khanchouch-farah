...
const HeroSection = () => {
    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
            Crafting intelligent solutions that bridge technology and real-world challenges.
            Available for PFE internship (Feb 2026)
          </motion.p>
  ...
  <div className="text-gray-500">{"// Final-Year Engineering Student"}</div>
  <div>
    <span className="text-pink-600">const</span>{" "}
    <span className="text-blue-600">Devloper</span>{" "}
  ...
  >
    ...
    <span className="text-gray-500">:</span>{" "}
    <span className="text-green-600">'Farah Khanchouch'</span>
    <span className="text-gray-500">,</span>
  </motion.div>
  ...
  >
    <span className="text-purple-600">motto</span>
    <span className="text-gray-500">:</span>{" "}
    <span className="text-green-600">'Code with purpose, build with passion'</span>
  </motion.div>
